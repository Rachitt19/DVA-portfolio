...
export default function Sidebar() {
  ...
  return (
    <aside className="sidebar">
      ...
      />
      <h1 className="sidebar-name">Rachit Gupta</h1>
      <p className="sidebar-username">rachitt19</p>
      ...
      <div className="sidebar-socials">
        <a
          href="https://www.linkedin.com/in/rachit-gupta19/"
          target="_blank"
          rel="noreferrer"
        ...
        <a
          href="https://github.com/Rachitt19"
          target="_blank"
          rel="noreferrer"
          className="sidebar-social-btn"
        >
      ...
      <div className="sidebar-info">
        ...
        <div className="sidebar-info-item">
          ...
          <a href="mailto:rachit.gupta2024@nst.rishihood.edu.in">rachit.gupta2024@nst.rishihood.edu.in</a>
        </div>
        <div className="sidebar-info-item">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="#8b949e">
